...
serve(async (req) => {
  ...
  try {
    ...
    // Send custom email with the actual OTP code
...
function generateOTPEmailTemplate(otp: string) {
  return `
  <!DOCTYPE html>
  <html>
  <head>
      ...
      <title>Your Mimaht Verification Code</title>
      <style>
          body {
  ...
  <body>
      <div class="container">
          ...
          <div class="content">
              ...
              <p>Please use the verification code below to sign in to your Mimaht account:</p>
              
              <div class="otp-code">${otp}</div>
              
              <div class="info">
                  <strong>📱 Enter this code in your app:</strong>
