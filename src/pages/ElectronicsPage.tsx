...
import { Cpu, Battery, HardDrive, Monitor, Radio, Shield, MemoryStick, Cpu as Chip, Waves, Smartphone, Laptop, Headphones, Tv, Watch, Camera, Gamepad2, Speaker, Tablet, Cable, Drone, Home, Monitor as Display } from "lucide-react";
...
const ElectronicsPage: React.FC<ElectronicsPageProps> = ({ category = 'electronics' }) => {
  ...
  // Define electronics-specific filter tabs
  ...
  const handleSubcategorySelect = (channelId: string) => {
    ...
    // Apply subcategory-specific default filters
    const subcategoryFilters: any = {};
