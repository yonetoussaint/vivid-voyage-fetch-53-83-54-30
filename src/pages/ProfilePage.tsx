    ...
    <div className="min-h-screen bg-slate-50 max-w-2xl mx-auto">
      ...
      <div className="bg-white text-gray-900 relative overflow-hidden">
        ...
        <div className="relative w-full overflow-hidden z-0">
          {/* Using a simple banner since HeroBanner might have dependencies */}
          <div className="w-full h-32 bg-gradient-to-r from-pink-500 via-red-500 to-orange-500 relative">
            <div className="absolute inset-0 flex items-center justify-center">
              <div className="text-white text-center">
                <h2 className="text-lg font-bold drop-shadow-lg">@johndoe</h2>
                <p className="text-sm opacity-90 drop-shadow">Premium Seller</p>
              </div>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center gap-1 text-xs text-gray-500">
                  <span className="font-mono whitespace-nowrap">
                    ID: {(() => {
                      ...
                      const twoLetters = sellerData.name.substring(0, 2).toUpperCase();
