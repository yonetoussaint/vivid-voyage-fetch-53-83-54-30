...
import { useKidsFilters, useKidsData } from "@/hooks/kids.hooks";

interface KidsPageProps {
  category?: string;
}

const KidsPage: React.FC<KidsPageProps> = ({ category = 'kids' }) => {
  ...
  const safeFilters = useMemo(() => {
    // Convert KidsFilters to FilterState expected by InfiniteContentGrid
    return {
      ...
      color: filters.color,
      educational: filters.educational,
      organic: filters.organic,
      bpaFree: filters.bpaFree,
    };
  }, [filters]);
