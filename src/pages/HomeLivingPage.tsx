...
import { useHomeLivingFilters, useHomeLivingData } from "@/hooks/home-living.hooks";
...
const HomeLiving: React.FC<HomeLivingPageProps> = ({ category = 'home-living' }) => {
  ...
  const safeFilters = useMemo(() => {
    // Convert HomeLivingFilters to FilterState expected by InfiniteContentGrid
    return {
