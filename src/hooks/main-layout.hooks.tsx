// ProductDetail.tsx - Fixed with React Portal for truly fixed header
...
const ProductDetailContent: React.FC<ProductDetailProps> = ({ 
  ...
  return (
    <>
      {/* FIXED HEADER - Using React Portal to render outside component tree */}
      {createPortal(
        <div
        ...
        document.body // ← Renders at root level, outside all parent constraints!
      )}
