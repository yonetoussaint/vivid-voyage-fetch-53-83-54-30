      ...
      <div className={isCompact ? "" : "flex-1 flex flex-col justify-center w-full p-0"}>
        <div className={isCompact ? "space-y-3 mb-4" : "space-y-3 mb-6"}>
          ...
          <button 
            ...
            className={`w-full flex items-center py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed relative ${
              isCompact ? 'shadow-sm' : ''
            }`}
          >
            ...
            <span className="text-gray-700 font-medium flex-1 text-center">
          ...
          >
            ...
            <TranslatedText className="text-gray-700 font-medium flex-1 text-center">
              Continue with Email
            </TranslatedText>
