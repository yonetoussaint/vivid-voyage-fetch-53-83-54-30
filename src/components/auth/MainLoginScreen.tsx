      ...
      <div className={isCompact ? "" : "flex-1 flex flex-col justify-center w-full p-0"}>
        <div className={isCompact ? "space-y-3 mb-4" : "space-y-3 mb-6"}>
          <button 
            ...
            className={`w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors ${isCompact ? 'shadow-sm' : ''}`}
          >
          ...
          <button className={`w-full flex items-center justify-center gap-3 py-3 px-4 border border-gray-300 rounded-lg hover:bg-gray-50 transition-colors ${isCompact ? 'shadow-sm' : ''}`}>
            <svg className="w-5 h-5 text-gray-700" fill="currentColor" viewBox="0 0 24 24">
