    ...
    <div className={isCompact ? "px-4 pb-4" : "min-h-screen bg-white flex flex-col px-4"}>
      ...
      {!isCompact && (
        <div className="pt-4 pb-4 flex items-center justify-between">
          ...
          <h2 className="text-lg font-semibold text-gray-900">Welcome Back! Sign In</h2>
      ...
      <div className={isCompact ? "" : "flex-1 flex flex-col justify-center w-full p-0"}>
        <div className={isCompact ? "space-y-3 mb-4" : "space-y-3 mb-6"}>
          ...
          {error && (
            <div
              className={`p-4 border border-red-200 bg-red-50 text-red-700 rounded-lg ${isCompact ? "mb-3" : "mb-4"}`}
            >
          ...
          <div className={isCompact ? "space-y-3" : "space-y-4"}>
            ...
            <div className="text-center">
              {canResend ? (
                ...
                <p className={`text-gray-500 ${isCompact ? "text-xs" : "text-sm"}`}>Resend code in {timeLeft}s</p>
              )}
            </div>
