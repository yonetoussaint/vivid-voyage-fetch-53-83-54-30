...
const MoneyCounterGrid = ({ 
  ...
  // For preset dropdown - you might want a different sorting or filtering
  ...
  // Calculate total for currently selected denomination
          ...
          <div className="space-y-1">
            {Object.entries(gridInputs)
              ...
              .map(([denomValue, value]) => {
                ...
                return (
                  <div key={denomValue} className="flex items-center justify-between text-sm">
                    <div className="flex items-center gap-2">
                      <div className={`${denom.color} px-2 py-1 rounded-md`}>
