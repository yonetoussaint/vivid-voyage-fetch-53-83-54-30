    ...
    <div className="bg-white border border-gray-200 rounded-lg shadow-sm overflow-hidden">
        ...
        <div className="flex items-center justify-between gap-2">
          <div className="flex items-center gap-3 flex-1 min-w-0">
            ...
            <div className="flex flex-col flex-1 min-w-0">
              ...
              {/* Removed "Ventes" line from header */}
            </div>
          </div>

          <div className="flex items-center gap-3 flex-shrink-0">
            {/* Total Deposits Display */}
            <div className="px-3 py-1.5 bg-blue-50 text-blue-700 rounded-full text-sm font-semibold border border-blue-200 min-w-[120px]">
              <div className="flex flex-col items-center">
                <span className="text-xs font-medium">Total Dépôts</span>
                <span>{formaterArgent(totalDepotHTG)} HTG</span>
              </div>
            </div>
      ...
      <div className={`overflow-hidden transition-all duration-300 ease-in-out border-t border-gray-100 ${
        ...
        <div className={`p-3 bg-gray-50 ${isExpanded ? 'block' : 'hidden'}`}>
          {/* Info Cards - Keeping all three cards in expanded view */}
