...
const PumpHeader = ({ pompe, shift, donneesPompe, vendeurs, mettreAJourAffectationVendeur, prix }) => {
  ...
  return (
    <div className="w-full space-y-3">
      ...
      {/* Statistiques Rapides - Same pattern as StatsCards */}
      ...
      {/* TOTAL GALLONS CARD - Exact same pattern */}
      ...
      {/* TOTAL SALES - Most Prominent Card - Exact same pattern */}
      <div className="bg-gradient-to-br from-indigo-600 to-purple-600 text-white rounded-xl p-4 shadow-xl">
        ...
        <div className="space-y-2">
          ...
          {/* Final Adjusted Total - ROUNDED - Exact same pattern */}
