...
const ReviewGallery: React.FC<ReviewGalleryProps> = ({
  ...
  // Check if we should render as grid (for reviews-gallery tab)
  const isGridLayout = customClass.includes('reviews-gallery-grid');
  ...
  return (
    <>
      <div className={`w-full overflow-hidden ${customClass}`}>
        ...
        {isGridLayout ? (
          // Grid layout for reviews-gallery tab
          <div className="grid grid-cols-3 gap-1 px-2 pb-2">
            {reviews.map((review, index) => (
              <div 
                key={review.id} 
                className="rounded-lg overflow-hidden shadow-md bg-black relative cursor-pointer aspect-square"
                ...
                <div className="relative bg-gray-200 w-full h-full">
                  ...
                  <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-1.5">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center text-gray-300 text-[10px] gap-0.5">
                        {review.type === 'video' ? (
                      ...
                      {/* Rating */}
                      <div className="flex items-center text-white text-[10px] rounded">
          ...
          // Horizontal scroll layout for other contexts
          <div 
