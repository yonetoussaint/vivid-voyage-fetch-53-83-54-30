// Fixed ProductHeader.tsx - Remove the loading state that returns null
...
const ProductHeader: React.FC<ProductHeaderProps> = ({
  ...
  // Inline scroll progress tracking - REMOVED isLoading state
  useEffect(() => {
    const onScroll = () => {
  ...
  // REMOVED the loading check that returns null
