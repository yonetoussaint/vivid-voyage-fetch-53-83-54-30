...
export default function SlideUpPanel({
  ...
  return (
    <>
      {/* Dynamic Backdrop - HIGHER Z-INDEX */}
      <div 
        className="fixed inset-0 bg-black/50 backdrop-blur-md z-[9998] transition-opacity duration-200"
        style={{ 
      ...
      {/* Panel with integrated header and drag handle - HIGHER Z-INDEX */}
      <div
        ref={panelRef}
        className="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 rounded-t-md shadow-lg z-[9999] flex flex-col"
        style={panelStyle}
