...
export const EducationSection: React.FC<EducationSectionProps> = ({ educationRef, visibleSections }) => {
  return (
    <section ref={educationRef} id="education" className="scroll-mt-20">
      ...
      <div className="space-y-4 mb-6">
        {education.map((edu, i) => (
          <AnimatedSection key={i} id="education" delay={i * 100} visibleSections={visibleSections}>
      ...
      <div className="space-y-3">
        {certifications.map((cert, i) => (
          <AnimatedSection key={i} id="education" delay={(education.length + i) * 100} visibleSections={visibleSections}>
