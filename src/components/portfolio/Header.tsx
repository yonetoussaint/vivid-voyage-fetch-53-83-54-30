      ...
      <div className="max-w-4xl mx-auto px-2 py-2">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              {/* Updated name to Yoné Toussaint */}
              <h1 className="font-bold text-lg">Yoné Toussaint</h1>
            ...
            <div className="px-4 py-4 border-b">
              <div className="flex items-center gap-3">
                <div className="w-16 h-16 rounded-full overflow-hidden bg-gradient-to-br from-blue-100 to-purple-100 flex items-center justify-center">
                  ...
                  <div className="text-2xl font-bold text-blue-600">YT</div>
                ...
                <div>
                  <h2 className="font-bold text-lg">Yoné Toussaint</h2>
                  <p className="text-sm text-gray-600">Full Stack Developer</p>
                  <div className="flex gap-1 mt-1">
                    <span className="text-xs px-2 py-1 bg-blue-50 text-blue-600 rounded">React</span>
                    <span className="text-xs px-2 py-1 bg-blue-50 text-blue-600 rounded">Node.js</span>
                    <span className="text-xs px-2 py-1 bg-blue-50 text-blue-600 rounded">TypeScript</span>
                  </div>
                </div>
              </div>
            </div>
            
            {/* Navigation tabs stacked below the profile picture */}
            <div className="py-2">
